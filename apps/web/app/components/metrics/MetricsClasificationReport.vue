        ...
        <CardContent>
            <div class="space-y-2">
                <div class="grid grid-cols-5 gap-2 pb-2 border-b border-border">
                    <div class="text-sm font-semibold text-muted-foreground">{{ t("class") }}</div>
                    <div class="text-sm font-semibold text-muted-foreground text-right">
                        {{ t("precision") }}
                    </div>
                    <div class="text-sm font-semibold text-muted-foreground text-right">
                        {{ t("recall") }}
                ...
                <div
                    ...
                    :key="idx"
                    :class="[
                        'grid grid-cols-5 gap-2 py-3 rounded-lg items-center',
                ...
                >
                    ...
                    <div class="text-sm text-right font-mono text-foreground">
                    ...
                    <div class="text-sm text-right font-mono text-muted-foreground">
